...
-- 1. Adicionar coluna de custo histórico se não existir
ALTER TABLE order_items ADD COLUMN IF NOT EXISTS product_cost_price NUMERIC DEFAULT 0;

-- 2. Atualizar Função RPC de Venda para incluir o Custo (CMV)
...
DECLARE
    ...
    v_product_cost NUMERIC; -- Variável para custo
BEGIN
    ...
    LOOP
        ...
        -- Busca Preço E Custo atual para o DRE
