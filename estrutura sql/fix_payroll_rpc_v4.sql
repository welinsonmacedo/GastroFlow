...
-- This script updates the close_payroll RPC to calculate totals BEFORE inserting the header,
-- satisfying NOT NULL constraints on total_cost, total_net, and employee_count.
