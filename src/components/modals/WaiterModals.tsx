        ...
        <div className={`fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 ${!isOpen ? 'hidden' : ''}`}>
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="p-4 border-t bg-gray-50">
                    <button onClick={handleConfirm} className="w-full py-4 text-lg font-black shadow-lg bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all">Confirmar R$ {calculateTotal().toFixed(2)}</button>
                </div>
            </div>
        </div>
    );
