...
const TenantApp = () => {
    ...
    // Layout simplificado: Removemos a Sidebar Global.
    // Cada rota agora é responsável por seu próprio layout completo (Full Screen).
    return (
        <div className="h-full w-full bg-gray-50 overflow-hidden">
            <Routes>
                ...
                {/* Módulos Operacionais - Full Screen */}
                ...
                {/* Painel Admin - Possui sua própria Sidebar interna */}
