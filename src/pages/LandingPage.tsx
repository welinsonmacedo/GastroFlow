      ...
      <div className="relative bg-slate-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center px-4 sm:px-0">
             <button 
                onClick={openWhatsApp}
                className="w-full sm:w-auto bg-green-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-green-50 shadow-lg shadow-green-600/25 transition-all flex items-center justify-center gap-2 hover:scale-105"
             >
      ...
      <div id="pricing" className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 md:mb-16">
                ...
                <p className="text-mt-4 text-slate-500">Comece pequeno e cresça com o Flux Eat.</p>
            </div>
