...
import { DollarSign, History, ShoppingCart, Search, Wallet, Receipt, Trash2, User, Lock, XCircle, RefreshCcw, LayoutGrid, CreditCard, Banknote, Zap, Plus, Eye, Package, Minus, CheckSquare, Square, AlertTriangle, LogOut, Bike, Loader2, Clock } from 'lucide-react';
...
// Importação do componente modular de Delivery
...
export const CashierDashboard: React.FC = () => {
  ...
  const handleAddToCart = () => {
      ...
      setPosCart([...posCart, { item: selectedItemForCart, quantity: itemQty, notes: itemNotes, extras: selectedExtras }]);
