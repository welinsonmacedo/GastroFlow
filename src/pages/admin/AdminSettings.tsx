    ...
    <div className="max-w-4xl mx-auto animate-fade-in pb-10">
        ...
        <Modal isOpen={isPaymentModalOpen} onClose={() => setIsPaymentModalOpen(false)} title={paymentForm.id ? "Editar Pagamento" : "Novo Meio de Pagamento"} variant="dialog" maxWidth="sm" onSave={handleSavePaymentMethod}>
             <div className="space-y-4">
                 ...
                 <div><label className="text-xs font-bold text-gray-500 uppercase">Tipo</label><select className="w-full border p-2 rounded-lg mt-1 bg-white" value={paymentForm.type} onChange={e => setPaymentForm({...paymentForm, type: e.target.value as any})}><option value="CREDIT">Crédito</option><option value="DEBIT">Débito</option><option value="PIX">Pix</option><option value="CASH">Dinheiro</option><option value="MEAL_VOUCHER">Vale Refeição</option></select></div>
