...
import { Building2, MapPin, Phone, Loader2, Share2, Clock, ShieldAlert, Lock, Save, SlidersHorizontal, ShieldCheck } from 'lucide-react';
...
export const AdminSettings: React.FC = () => {
  ...
  const [activeSettingsTab, setActiveSettingsTab] = useState<'BUSINESS' | 'RULES' | 'SECURITY'>('BUSINESS');
    ...
    <div className="max-w-4xl mx-auto animate-fade-in pb-10">
        ...
        <div className="space-y-8">
            ...
            {activeSettingsTab === 'RULES' && (
                <div className="bg-white p-8 rounded-2xl shadow-sm border-2 border-blue-100 overflow-hidden relative animate-fade-in">
                    ...
                    <div className="flex items-start gap-4 mb-6">
                        ...
                        <div><h2 className="text-xl font-bold text-gray-800">Tempo de Arrependimento</h2><p className="text-sm text-gray-500 leading-relaxed">Janela de tempo após o pedido em que o cliente pode cancelar de forma autônoma. Durante este tempo, o pedido **NÃO** aparece na cozinha.</p></div>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200">
                        ...
                        <div className="flex justify-between mt-2 text-[10px] font-bold text-gray-400"><span>0 min (Envio Instantâneo)</span><span>10 min (Segurança Máxima)</span></div>
                    </div>
                    <div className="mt-4 p-4 bg-orange-50 rounded-xl border border-orange-100 flex gap-3"><ShieldAlert className="text-orange-500 shrink-0" size={20} /><p className="text-[11px] text-orange-800 font-medium italic">Recomendamos de 2 a 3 minutos para dar tempo ao cliente de corrigir erros sem impactar a velocidade da cozinha.</p></div>
                </div>
            )}
            ...
            {activeSettingsTab === 'SECURITY' && (
                <div className="bg-white p-8 rounded-2xl shadow-sm border-2 border-red-100 animate-fade-in">
                    <div className="flex items-start gap-4 mb-6">
                        ...
                        <div><h2 className="text-xl font-bold text-gray-800">Segurança</h2><p className="text-sm text-gray-500 leading-relaxed">Configurações sensíveis e de proteção do sistema.</p></div>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200">
            ...
            <div className="pt-4 border-t border-gray-200">
                <Button onClick={handleSaveBusiness} className="w-full py-4 text-lg shadow-lg flex items-center justify-center gap-2"><Save size={20}/> Salvar Dados do Sistema</Button>
            </div>
        </div>
    </div>
  );
