...
import { Palette, LayoutTemplate, Type, Image as ImageIcon, Smartphone, ChefHat, Search, ShoppingCart, Plus } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto animate-fade-in pb-10">
        <header className="mb-8">
            <h2 className="text-2xl font-bold text-gray-800">Aparência do Cardápio</h2>
            <p className="text-gray-500">Personalize como seus clientes visualizam sua loja.</p>
        </header>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            <div className="flex-1 space-y-6">
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    ...
                    <p className="text-sm text-gray-500 mb-6">Defina a identidade visual.</p>
