...
const PricingCard: React.FC<{ plan: Plan, onClick: () => void }> = ({ plan, onClick }) => {
    ...
    return (
      <div className={`relative bg-white rounded-2xl p-8 border flex flex-col ${plan.is_popular ? 'border-green-500 shadow-2xl scale-105 z-10' : 'border-slate-200 shadow-sm'}`}>
        {plan.is_popular && (
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-green-600 text-white px-4 py-1 rounded-full text-sm font-bold shadow-lg">
            Mais Popular
          </div>
        )}
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 relative">
      ...
      <div className="relative bg-slate-900 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-500 rounded-full blur-[120px] opacity-20 transform translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-green-500 rounded-full blur-[120px] opacity-20 transform -translate-x-1/2 translate-y-1/2"></div>
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 bg-slate-800/80 border border-slate-700/50 backdrop-blur-sm rounded-full px-4 py-1.5 mb-8 shadow-xl">
          ...
          <p className="text-xl sm:text-2xl text-slate-300 mb-10 max-w-2xl font-medium tracking-tight">
            Onde gestão e vendas acontecem sem parar.
          </p>
          <p className="text-slate-400 mb-10 max-w-xl text-sm leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
             <button 
                onClick={openWhatsApp}
                className="bg-green-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-green-500 shadow-lg shadow-green-600/25 transition-all flex items-center justify-center gap-2 hover:scale-105"
             >
                <MessageCircle size={20} /> Experimentar Grátis
             </button>
             <a 
                href="#contact"
                className="bg-white/5 backdrop-blur-md text-white border border-white/10 px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/10 transition-all flex items-center justify-center gap-2"
             >
                Ver Demonstração <ArrowRight size={20} />
             </a>
          </div>

          <div className="mt-16 flex flex-wrap justify-center gap-6 sm:gap-12 text-slate-400 text-sm font-bold uppercase tracking-wider">
             <div className="flex items-center gap-2"><CheckCircle size={18} className="text-green-500" /> Instalação Imediata</div>
             <div className="flex items-center gap-2"><CheckCircle size={18} className="text-green-500" /> Suporte Humanizado</div>
             <div className="flex items-center gap-2"><CheckCircle size={18} className="text-green-500" /> Sem Fidelidade</div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-32">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
                <div className="lg:w-1/2 relative flex justify-center items-center group w-full">
                    {/* Background Blob */}
                    <div className="absolute inset-0 bg-green-100 rounded-full blur-3xl opacity-60 scale-90 group-hover:scale-100 transition-transform duration-1000"></div>
                    ...
                    <div className="relative bg-slate-900 rounded-2xl p-2 shadow-2xl w-full max-w-md transform group-hover:-translate-y-2 transition-transform duration-500">
                        <div className="bg-slate-800 rounded-xl overflow-hidden border border-slate-700 h-[280px] relative flex">
                            ...
                            <div className="w-16 bg-slate-900 border-r border-slate-700 flex flex-col items-center py-4 gap-4">
                                <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center"><ChefHat size={16} className="text-white"/></div>
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row border border-slate-100">
                <div className="bg-slate-900 p-8 md:w-2/5 flex flex-col justify-between text-white">
                    <div>
                        ...
                        <p className="text-slate-400 mb-6">Preencha o formulário e um especialista entrará em contato para liberar seu acesso demonstração.</p>
                        <ul className="space-y-3">
